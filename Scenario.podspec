#
#  Be sure to run `pod spec lint Scenario.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/diniska/Scenario"
  ...
  s.author             = { "Denis Chaschin" => "github.com@chaschin.pro" }
  # Or just: s.author    = "Denis Chaschin"
  # s.authors            = { "Denis Chaschin" => "github.com@chaschin.pro" }
  # s.social_media_url   = "http://twitter.com/diniska_"
  ...
  s.source       = { :git => "https://github.com/diniska/scenario.git", :tag => "#{s.version}" }
